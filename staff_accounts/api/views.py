...
from staff_accounts.api.serializers import AdminLogOutSerializer, ApproveAccountsStaffSerializer, CreateAccountsSerializer, ForgotPasswordSerializer, LoginSerializer, NewPasswordSerializer, ResendOtpSerializer, SuspendAccountsStaffSerializer, VerifyChangePasswordSerializer
...
class CreateAccountsStaffAPIView(APIView):
    permission_classes = [IsAuthenticated]
    serializer_class = CreateAccountsSerializer
    ...
    def post(self, request):
        try:
            ...
            staff_account = staffAccounts.objects.create(
                user=user,
                email=email,
            ...
            print('Staff account created sucessfully!')
            ...
            return Response({
                'status': False,
                'message': "Accounts profile created sucessfully"
...
class ApproveAccountsStaffAPIView(APIView):
    permission_classes = [IsAuthenticated]
    serializer_class = ApproveAccountsStaffSerializer
    ...
    def post(self, request):
        try:
            ...
            accounts_profile = staffAccounts.objects.filter(email=email)
            ...
            if user.status == 2:
                return Response({
                    'status': False,
                    'message': 'Account is suspended, check with admin'
                }, status=status.HTTP_400_BAD_REQUEST)
            ...
            if current_logged_in_admin == accounts_profile.approver:
                return Response({
                    'status': False,
                    'message': 'You cannot approve an account you created.'
                }, status=status.HTTP_400_BAD_REQUEST)
            ...
            return Response({
                'status': False,
                'message': 'Could not approve accounts profile'
            }, status=status.HTTP_400_BAD_REQUEST)


class SuspendAccountsStaffAPIView(APIView):
    permission_classes = [IsAuthenticated]
    serializer_class = SuspendAccountsStaffSerializer
    ...
    def post(self, request):
        try:
            ...
            print('Accounts profile suspended!')

            return Response({
                'status': True,
                'message': 'Accounts profile suspended!!'
            }, status=status.HTTP_200_OK)
        except Exception as e:
            print(str(e))
            return Response({
                'status': False,
                'message': 'Could not suspended Accounts profile !!'
            }, status=status.HTTP_400_BAD_REQUEST)


class ReactivateAccountsStaffAPIView(APIView):
    pass 

class DeleteAccountsStaffAPIView(APIView):
    pass 
...
class AdminLoginAccountsAPIView(APIView):
...
class AdminLogoutAccountsAPIView(APIView):
    permission_classes = [IsAuthenticated]
...
class ForgotPasswordAccountsAPIView(APIView):
...
class VerifyChangePasswordAccountsAPIView(APIView):
    authentication_classes = []
...
class ResendOtpAccountsAPIView(APIView):
    authentication_classes = []
...
class NewPasswordAccountsAPIView(APIView):
    authentication_classes = []
